<nav class="sidebar">
      ...
      <div class="sidebar-body">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a href="{{ route('price-settings.index') }}" class="nav-link">
              <i class="link-icon" data-feather="calendar"></i>
              <span class="link-title">Price Setting</span>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{ route('package-types.index') }}" class="nav-link">
              <i class="link-icon" data-feather="calendar"></i>
              <span class="link-title">Package Types</span>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{ route('logistic-transactions.index') }}" class="nav-link">
              <i class="link-icon" data-feather="calendar"></i>
              <span class="link-title">Transaction History</span>
            </a>
          </li>
